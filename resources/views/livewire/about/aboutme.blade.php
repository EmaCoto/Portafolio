<div>
    ...
    <button wire:click="$toggle('open')" class="group relative overflow-hidden">Acerca de mí <span class="absolute h-0.5 bg-[#65B741] bottom-0 left-0 w-1/2 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-200 ease-in-out"></span></button>
